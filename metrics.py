...
def compute_diversity(embeddings):
    ...
    np.clip(distance_matrix, 0, None, out=distance_matrix) # Ensure distances are non-negative
    ...
    if n > PCA_DIMENSIONS: # Need n_samples > n_components for PCA
        try:
            ...
            print("Warning: scipy.spatial.ConvexHull could not be imported. Hull area will be 0.")
